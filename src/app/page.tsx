...
import { Sparkles, RefreshCcw, Loader2, Menu } from "lucide-react";
          ...
          <div className="container mx-auto px-4 flex items-center justify-between">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="overflow-hidden">
                ...
                <p className="md:hidden text-[8px] font-bold uppercase tracking-widest text-orange-700 opacity-80">Performance</p>
              </div>
            </div>
